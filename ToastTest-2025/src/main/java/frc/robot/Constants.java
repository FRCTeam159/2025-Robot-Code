...
public class Constants {
    ...
    public static final double kFrontLeftOffset = 0.0593; //0.0458984;//-0.405518;
    public static final double kFrontRightOffset = -0.3133;//0.403076;
    public static final double kBackLeftOffset = -0.224;//0.268555;
    public static final double kBackRightOffset = -0.1792;//0.156730;
